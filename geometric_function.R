...
amstat_geometric_trials <- function(prob_success = 0.5, k_trials_to_success = c(1, 2, 3)) {
...
amstat_geometric_fails <- function(prob_success = 0.5, k_failures_to_success = c(0, 1, 2, 3)) {
